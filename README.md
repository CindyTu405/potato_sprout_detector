...
```Bash
git clone [https://github.com/CindyTu405/potato_sprout_detector.git](https://github.com/CindyTu405/potato_sprout_detector.git)
...
**選項 B：啟動 Line Bot 服務**
    ...
    2. 程式啟動後，開啟 Ngrok 並將本地 Port 映射至外網，取得 https 開頭的網址。
